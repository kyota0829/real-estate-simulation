...
// 市区町村選択　関数
    const municipalities = {
        ...
        9: [ 
            { value: '09201', name: '宇都宮市' },
            { value: '09202', name: '足利市' },
            { value: '09203', name: '栃木市' },
            { value: '09204', name: '佐野市' },
            { value: '09205', name: '鹿沼市' },
            { value: '09206', name: '日光市' },
            { value: '09208', name: '小山市' },
            { value: '09209', name: '真岡市' },
            { value: '09210', name: '大田原市' },
            { value: '09211', name: '矢板市' },
            { value: '09213', name: '那須塩原市' },
            { value: '09214', name: 'さくら市' },
            { value: '09215', name: '那須烏山市' },
            { value: '09216', name: '下野市' },
            { value: '09301', name: '上三川町' },
            { value: '09342', name: '益子町' },
            { value: '09343', name: '茂木町' },
            { value: '09344', name: '市貝町' },
            { value: '09345', name: '芳賀町' },
            { value: '09361', name: '壬生町' },
            { value: '09364', name: '野木町' },
            { value: '09384', name: '塩谷町' },
            { value: '09386', name: '高根沢町' },
            { value: '09407', name: '那須町' },
            { value: '09411', name: '那珂川町' }
        ],
        10: [
            { value: '10201', name: '前橋市' },
            { value: '10202', name: '高崎市' },
            { value: '10203', name: '桐生市' },
            { value: '10204', name: '伊勢崎市' },
            { value: '10205', name: '太田市' },
            { value: '10206', name: '沼田市' },
            { value: '10207', name: '館林市' },
            { value: '10208', name: '渋川市' },
            { value: '10209', name: '藤岡市' },
            { value: '10210', name: '富岡市' },
            { value: '10211', name: '安中市' },
            { value: '10212', name: 'みどり市' },
            { value: '10344', name: '榛東村' },
            { value: '10345', name: '吉岡町' },
            { value: '10366', name: '上野村' },
            { value: '10367', name: '神流町' },
            { value: '10382', name: '下仁田町' },
            { value: '10383', name: '南牧村' },
            { value: '10384', name: '甘楽町' },
            { value: '10421', name: '中之条町' },
            { value: '10424', name: '長野原町' },
            { value: '10425', name: '嬬恋村' },
            { value: '10426', name: '草津町' },
            { value: '10428', name: '高山村' },
            { value: '10429', name: '東吾妻町' },
            { value: '10443', name: '片品村' },
            { value: '10444', name: '川場村' },
            { value: '10448', name: '昭和村' },
            { value: '10449', name: 'みなかみ町' },
            { value: '10464', name: '玉村町' },
            { value: '10521', name: '板倉町' },
            { value: '10522', name: '明和町' },
            { value: '10523', name: '千代田町' },
            { value: '10524', name: '大泉町' },
            { value: '10525', name: '邑楽町' }
        ],    
    11: [
